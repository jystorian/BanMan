...
const I18N_DICTIONARY = {
  ko: {
    ...
    backup_card_desc: '차단 규칙 및 요소 가리기 규칙을 JSON 파일로 안전하게 내보내거나 가져옵니다.',
    stat_total: '전체 등록 규칙',
    stat_block: '사전 차단',
    stat_warn: '주의',
    stat_hide: '링크 숨김',
  ...
  en: {
    ...
    hl_type_star: '⭐ Star / Like',
    hl_type_pin: '📌 Review',
    hl_type_custom: '✨ Custom',
    ...
    ctx_hl_star: '⭐ Star / Like',
    ctx_hl_pin: '📌 Mark for Review',
    ctx_hl_custom: '✨ Custom Highlight',
    ctx_remove: '🗑️ Remove',
  ...
  ja: {
    ...
    ctx_hide: '👁️‍🗨️ 非表示',
    ctx_highlight: '✨ 強調',
    ctx_hl_star: '⭐ おすすめ / いいね',
    ctx_hl_pin: '📌 要確認',
    ctx_hl_custom: '✨ カスタム強調',
    ctx_remove: '🗑️ 登録解除',
